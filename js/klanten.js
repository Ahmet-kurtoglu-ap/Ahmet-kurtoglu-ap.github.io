...
const complimenten = ["klantvriendelijkheid", "snel werk", "goede prijs/kwaliteit verhouding", "service", "website", "stiptheid", "vlotte communicatie"];
// array met merken van koffiebonen
...
fetch('https://randomuser.me/api/?results=6')
    ...
    .then(function (response) {
        ...
        for (let i = 0; i < response.results.length; i++) {
			...
			<p class="card-text h6 small mt-2">Ik kom uit ${random_item(woonplaats)} en vind domotica-systemen ${random_item(complimenten)} heel goed !</p>
            </div>
      </div>`;
        }
        html += '</section>';
